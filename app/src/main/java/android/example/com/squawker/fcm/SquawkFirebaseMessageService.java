...
// https://github.com/udacity/AdvancedAndroid_Squawker/compare/TFCM.04-Exercise-AddFirebaseMessagingService...TFCM.04-Solution-AddFirebaseMessagingService
...
// date: Ex. 1484358455343
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        // Data messages are handled here in onMessageReceived whether the app is in the foreground or background. They are the type
        ...
        // containing both notification and data payloads are treated as notification messages. The Firebase console always
        // sends notification messages. For more see: https://firebase.google.com/docs/cloud-messaging/concept-options\
        ...
        Log.d(LOG_TAG, "From: " + remoteMessage.getFrom());   // eg: From: 354380738701

        // Check if message contains a data payload.
        // Get a map of data with keys and values
        Map<String, String> data = remoteMessage.getData();

        // eg
        String author = data.get("author");
        Log.d(LOG_TAG, "Author is: " + author);   // Author is: TestAccount

        // TODO (3) As part of the new Service - If there is message data, get the data using the keys and do two things with it :
...
// Hint: You shouldn't be doing content provider operations on the main thread.
        if (data.size() > 0) {
            ...
            // eg: Message data payload: {author=TestAccount, date=1578993490330, message=DIY, dreamcatcher church-key authentic butcher fixie squid, authorKey=key_test}

            // Add the squawk to database and send a notification that you got a new message
